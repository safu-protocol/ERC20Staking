...
/// @title SAFU Guardian Staking Contract
/// @notice Staking Contract that uses the Synthetix Staking model to distribute SAFU(ERC-20) token rewards in a dynamic way, proportionally based on the amount of LP Tokens staked by each staker at any given time
